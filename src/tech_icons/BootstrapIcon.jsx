export default function BootstrapIcon({ width }) {
  ...
  return (
    <div title="Bootstrap" className="svg-shadow" style={{ "width": width }}>
      <svg viewBox="0 0 128 127" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient
            id="bootstrap-original-wordmark-a"
            x1="76.079"
            x2="523.48"
            y1="10.798"
            y2="365.95"
          ...
          <linearGradient
            id="bootstrap-original-wordmark-b"
            x1="193.51"
            x2="293.51"
            y1="109.74"
            y2="278.87"
          ...
          <filter
            id="bootstrap-original-wordmark-c"
            x="161.9"
            y="135.46"
            width="197"
            height="249"
        ...
        <path
          fill="url(#bootstrap-original-wordmark-a)"
        ...
        />
        <path
          fill="url(#bootstrap-original-wordmark-b)"
          filter="url(#bootstrap-original-wordmark-c)"
          stroke="#fff"
