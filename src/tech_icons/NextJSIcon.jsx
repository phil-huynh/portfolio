export default function NextJSIcon({ width }){

  return (
    <div title="Next JS" className="svg-shadow" style={{ "width": width }}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 26 128 70">
        <path
          fill="#FFFFFF"
