  ...
  return (
    ...
    <div title="Ruby" className="svg-shadow" style={{...iconStyle, "width": '5rem'}}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
        ...
        <path
          fill="url(#ruby-original-wordmark-a)"
          d="M87.524 58.767L38.638 87.795l63.3-4.294 4.875-63.828z"
        />
        <linearGradient
          id="ruby-original-wordmark-b"
          gradientUnits="userSpaceOnUse"
          x1="152.913"
          y1="2152.229"
          x2="129.634"
        ...
        <path
          fill="url(#ruby-original-wordmark-b)"
          d="M102.041 83.457L96.6 45.905l-14.818 19.57z"
        />
        <linearGradient
          id="ruby-original-wordmark-c"
          gradientUnits="userSpaceOnUse"
          x1="134.287"
          y1="2124.472"
          x2="111.008"
        ...
        <path
          fill="url(#ruby-original-wordmark-c)"
          d="M102.114 83.457l-39.858-3.129-23.405 7.385z"
        />
        <linearGradient
          id="ruby-original-wordmark-d"
          gradientUnits="userSpaceOnUse"
          x1="85.411"
          y1="2163.54"
          x2="89.02"
        ...
        <path
          fill="url(#ruby-original-wordmark-d)"
          d="M38.906 87.722l9.957-32.62-21.91 4.686z"
        />
        <linearGradient
          id="ruby-original-wordmark-e"
          gradientUnits="userSpaceOnUse"
          x1="110.233"
          y1="2185.439"
          x2="111.563"
        ...
        <path
          fill="url(#ruby-original-wordmark-e)"
          d="M81.777 65.582l-9.162-35.887-26.219 24.577z"
        />
        <linearGradient
          id="ruby-original-wordmark-f"
          gradientUnits="userSpaceOnUse"
          x1="132.261"
          y1="2207.563"
          x2="136.242"
        ...
        <path
          fill="url(#ruby-original-wordmark-f)"
          d="M104.734 30.201L79.949 9.958l-6.901 22.313z"
        />
        <linearGradient
          id="ruby-original-wordmark-g"
          gradientUnits="userSpaceOnUse"
          x1="120.105"
          y1="2213.604"
          x2="137.258"
        ...
        <path
          fill="url(#ruby-original-wordmark-g)"
          d="M93.142 2.741l-14.576 8.056-9.197-8.164z"
        />
        <linearGradient
          id="ruby-original-wordmark-h"
          gradientUnits="userSpaceOnUse"
          x1="70.375"
          y1="2169.518"
          x2="71.787"
        ...
        <path
          fill="url(#ruby-original-wordmark-h)"
          d="M21.188 70.73l6.107-11.137-4.941-13.267z"
        />
        <path
          fill="#fff"
          d="M22.026 45.905l4.97 14.098 21.595-4.845 24.655-22.913 6.958-22.1-10.955-7.737-18.627 6.971c-5.868 5.458-17.256 16.258-17.667 16.461-.406.208-7.519 13.653-10.929 20.065z"
        />
        <linearGradient
          id="ruby-original-wordmark-i"
          gradientUnits="userSpaceOnUse"
          x1="60.669"
          y1="2151.563"
          x2="127.036"
        ...
        <path
          fill="url(#ruby-original-wordmark-i)"
          d="M39.477 20.581C52.196 7.97 68.592.52 74.884 6.869c6.289 6.348-.38 21.776-13.099 34.382C49.067 53.858 32.873 61.719 26.586 55.37c-6.294-6.344.173-22.183 12.891-34.789z"
        />
          <linearGradient
            id="ruby-original-wordmark-j"
            gradientUnits="userSpaceOnUse"
            x1="111.505"
            y1="2144.677"
            x2="91.514"
        ...
        <path
          fill="url(#ruby-original-wordmark-j)"
          d="M38.906 87.709l9.879-32.724 32.811 10.541c-11.864 11.125-25.058 20.528-42.69 22.183z"/><linearGradient id="ruby-original-wordmark-k" gradientUnits="userSpaceOnUse"
          x1="145.839"
          y1="2168.67"
          x2="128.08"
          y2="2184.586"
        ...
        <path
          fill="url(#ruby-original-wordmark-k)"
          d="M73.289 32.181l8.423 33.363c9.91-10.419 18.804-21.621 23.159-35.476l-31.582 2.113z"
        />
        <linearGradient
          id="ruby-original-wordmark-l"
          gradientUnits="userSpaceOnUse"
          x1="152.364"
          y1="2197.874"
          x2="143.518"
        ...
        <path
          fill="url(#ruby-original-wordmark-l)"
          d="M104.785 30.236c3.371-10.174 4.148-24.768-11.746-27.477L79.996 9.963l24.789 20.273z"
        />
        <path
          fill="#9E1209"
          d="M21.188 70.583c.467 16.789 12.581 17.04 17.741 17.188l-11.92-27.837-5.821 10.649z"
        />
        <radialGradient
          id="ruby-original-wordmark-m"
          cx="130.847"
          cy="2184.281"
          r="21.762"
          gradientTransform="matrix(1 0 0 -1 -47.5 2221)"
        ...
        <path
          fill="url(#ruby-original-wordmark-m)"
          d="M73.337 32.232c7.615 4.68 22.96 14.08 23.271 14.253.484.272 6.617-10.342 8.008-16.34l-31.279 2.087z"
        />
        <radialGradient
          id="ruby-original-wordmark-n"
          cx="100.707"
          cy="2155.602"
          r="28.932"
          gradientTransform="matrix(1 0 0 -1 -47.5 2221)"
        ...
        <path
          fill="url(#ruby-original-wordmark-n)"
          d="M48.772 54.986l13.207 25.48c7.81-4.235 13.924-9.395 19.526-14.922L48.772 54.986z"
        />
        <linearGradient
          id="ruby-original-wordmark-o"
         gradientUnits="userSpaceOnUse"
         x1="80.214"
         y1="2133.309"
         x2="73.005"
        ...
        <path
          fill="url(#ruby-original-wordmark-o)"
          d="M26.957 59.969l-1.872 22.282c3.532 4.823 8.389 5.241 13.485 4.866-3.687-9.175-11.051-27.521-11.613-27.148z"
        />
        <linearGradient
          id="ruby-original-wordmark-p"
          gradientUnits="userSpaceOnUse"
          x1="135.518"
          y1="2214.356"
          x2="151.68"
        ...
        <path
          fill="url(#ruby-original-wordmark-p)"
          d="M79.919 10.02l26.237 3.683c-1.401-5.935-5.701-9.763-13.03-10.961L79.919 10.02z"
        />
      </svg>
    </div>
